...
export const popupSubmit = document.getElementById('submit-popup');
export const profileAvatar = document.querySelector('.profile__avatar');
export const popupEditAvatar = document.getElementById('avatar-popup');
...
export const editAvatar = document.querySelector('.profile__image-link');
